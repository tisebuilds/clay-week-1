...
export function ActionsPanelV3() {
  ...
  return (
    <aside className="flex h-full w-[360px] shrink-0 flex-col overflow-hidden border-l border-neutral-200 bg-white">
      ...
      <div className="flex items-center justify-between px-4 pb-2 pt-3">
        ...
        <button
          type="button"
          className="inline-flex items-center gap-1 text-xs font-normal text-neutral-700 underline decoration-neutral-400 underline-offset-2 transition-colors hover:text-neutral-900"
        >
